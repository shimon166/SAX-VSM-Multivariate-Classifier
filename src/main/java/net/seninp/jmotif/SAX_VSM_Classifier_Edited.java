 ...
 * 
 */
public class SAX_VSM_Classifier_Edited {
  ...
  public static double Sax_VSM_Classifier_Test(int alphabet_size,int paa_size, int window_size) throws SAXException{
    ...
    Params params = new Params(SAXVSMClassifierParams.SAX_WINDOW_SIZE,
        ...
        SAXVSMClassifierParams.SAX_NORM_THRESHOLD, SAXVSMClassifierParams.SAX_NR_STRATEGY,"_x_acc");
    return classify(params);
   }

  private static double classify(Params params) throws SAXException {
